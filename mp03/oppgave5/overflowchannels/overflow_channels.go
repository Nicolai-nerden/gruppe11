...
func Int8Overflow(sum int, ch chan bool) {
	var a int8 = 1
	var b int8 = 2
...
func Int32Overflow(sum int, ch chan bool) {
	var a int32 = 1
	var b int32 = 2
...
func Uint32Overflow(sum int, ch chan bool) {
	var a uint32 = 1
	var b uint32 = 2
...
func Int64Overflow(sum int, ch chan bool) {
	var a int64 = 1
	var b int64 = 2
